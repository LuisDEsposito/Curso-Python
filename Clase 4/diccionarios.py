...
divisa_solicitada = input("Que divisa desea utilizar: " )
if divisa_solicitada in divisas:
    print(f"Perfecto, continuemos con lo siguiente divisa: {divisa_solicitada}")
else:
    print("Lo siento, la divisa solicitada no esta diponible para operar.")
"""
